...
export const SQLITE_MANIFEST: readonly string[] = [
    ...
    "divergence ::: #4 $type null on missing fields ::: sqlite where clause builder > 15. Nullish matrix > $type 'null' on a missing field",
    "divergence ::: #4 $type null on missing fields ::: sqlite where clause builder > 22. $type mapping > 22.10 $type \"null\" on a missing field",
    "divergence ::: $type null on missing field: SQL returns SQL NULL not JSON null type ::: sqlite where clause builder > 2. Scalar value comparisons > $type > $type \"null\" on missing optional field (JS treats missing as null; SQL may not)",
